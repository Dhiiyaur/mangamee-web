...
// export const fetcherSearchManga = async({url, title}) => {
...
export const fetcherSearchManga = async(url, params) => await axios.get(url, { params : {title : params}}).then(res => res.data)